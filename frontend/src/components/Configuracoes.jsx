...
export default function Configuracoes({
  ...
  const handleTestCloudConnection = async () => {
    if (!nfStockEmail || !nfStockToken) {
      alert(
        "E-mail e Token de Integração são obrigatórios para realizar o teste.",
      );
      return;
    }
    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        setCloudTestResult({
          success: false,
          message: data.error || "Erro ao conectar com Alterdata.",
        });
      }
    } catch (err) {
      setCloudTestResult({
        success: false,
        message: "Falha de rede ao se comunicar com o backend local.",
      });
    } finally {
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Ajuste os parâmetros de importação, rotas físicas locais e a
            integração direta com a Nuvem Alterdata.
          </p>
        </div>
      </div>
      ...
      <div className="grid-2">
        ...
        >
          ...
          >
            ...
            >
              <label className="switch-label">
                <div>
                  ...
                  >
                    1. Sincronização Local (Pasta Física)
                  </span>
                  <p
                    style={{
                      fontSize: "0.75rem",
                  ...
                  >
                    Salva os XMLs e PDFs na rede local para a rotina automática
                    clássica do Alterdata Fiscal.
                  </p>
                </div>
            ...
            {enableFolderSync && (
              ...
              >
                <label className="form-label">
                  Diretório de Destino (Alterdata Sync)
                </label>
                <input
                  type="text"
                ...
                >
                  Caminho da pasta local compartilhada onde o Facilita Contábil
                  estruturará os XMLs.
                </p>
              </div>
            )}
            ...
            >
              <label className="switch-label">
                <div>
                  ...
                  >
                    Envia diretamente à nuvem da Alterdata via API. Importa no
                    Fiscal automaticamente de qualquer lugar.
                  </p>
                </div>
                <label className="switch">
                  <input
            ...
            {enableCloudSync && (
              <div
                style={{
                  ...
                  gap: "1rem",
                  paddingLeft: "1rem",
                  borderLeft: "2px solid var(--success-light)",
                  marginBottom: "0.5rem",
                }}
              >
                <div className="form-group" style={{ margin: 0 }}>
                  <label className="form-label">
                    E-mail Cadastrado no NF-Stock
                  </label>
                  <input
                    type="email"
                ...
                <div className="form-group" style={{ margin: 0 }}>
                  <label className="form-label">
                    Token de Integração API / NF-Stock
                  </label>
                  <input
                    type="password"
                ...
                {cloudTestResult && (
                  <div
                    style={{
                      display: "flex",
                      gap: "0.5rem",
                      background: cloudTestResult.success
                        ? "rgba(5, 150, 105, 0.08)"
                        : "rgba(220, 38, 38, 0.08)",
            ...
            <div className="form-row" style={{ marginTop: "0.5rem" }}>
              <div className="form-group" style={{ margin: 0 }}>
                <label className="form-label">
                  Intervalo de Busca na SEFAZ
                </label>
                <select
                  className="form-input"
                  value={autoSyncIntervalMinutes}
                  onChange={(e) =>
                    setAutoSyncIntervalMinutes(Number(e.target.value))
                  }
                >
            ...
            >
              <button
                ...
                onClick={() => {
                  if (
                    confirm(
                      "Deseja limpar todos os logs de sincronização registrados no painel?",
                    )
                  ) {
                    onClearLogs();
                  }
        ...
        >
          ...
          >
            ...
            >
              <p>
                A integração <strong>Alterdata NF-Stock</strong> conecta o
                Facilita Contábil diretamente à nuvem da Alterdata.
              </p>
              <ul
                style={{
                  paddingLeft: "1.25rem",
              ...
              >
                <li>
                  <strong>Sem fios ou rede local:</strong> As notas de entrada e
                  saída são despachadas via internet direto para o banco de
                  dados Alterdata.
                </li>
                <li>
                  <strong>Multi-computador:</strong> Não importa de onde você
                  acesse o Facilita Contábil, as notas caem direto no Fiscal dos
                  computadores do escritório.
                </li>
                <li>
                  <strong>Segurança:</strong> Backup automático dos XMLs fiscais
                  armazenados na nuvem oficial da Alterdata.
                </li>
              </ul>
              ...
              >
                ...
                />
                <span>
                  <strong>Como ativar:</strong> Obtenha o token de API no seu
                  painel do Alterdata e-Contador / NF-Stock e cole-o nas
          ...
          >
            ...
            >
              <p>Se preferir manter a importação por diretório clássico:</p>
              <ol
                style={{
                  paddingLeft: "1.25rem",
                  display: "flex",
              ...
              >
                <li>
                  Abra o <strong>Alterdata Fiscal</strong> &gt;{" "}
                  <strong>Área Trabalho</strong> &gt;{" "}
                  <strong>Rotinas Automáticas</strong>.
                </li>
                <li>
                  Defina uma rotina de <strong>Importação de XML</strong>{" "}
                  apontando para o mesmo diretório local configurado ao lado.
                </li>
                <li>
                  O Facilita Contábil se encarrega de organizar tudo nas
                  subpastas e injetar o DANFE em HTML para conferência rápida
