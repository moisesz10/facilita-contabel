...
const renderChannelStatus = (status, type) => {
  ...
  const label =
    type === "local" ? "Pasta Local (e-Drive)" : "Nuvem Alterdata (NF-Stock)";
      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Consulte, baixe e force a sincronização manual de notas no
            Alterdata.
          </p>
        </div>
      </div>
        ...
        {filteredInvoices.length === 0 ? (
          ...
          >
            ...
            <p style={{ fontSize: "0.9rem", marginTop: "0.5rem" }}>
              Tente alterar os filtros ou realize uma busca de novas notas na
              SEFAZ.
            </p>
          </div>
        ) : (
                  ...
                  <tr key={inv.chave}>
                    ...
                    <td>
                      <div style={{ fontSize: "0.9rem", fontWeight: "600" }}>
                        {getCompanyName(inv.companyCnpj)}
                      </div>
                    </td>
                    <td>
                      {inv.type === "entrada" ? (
                        <div>
                          ...
                          >
                            Emit: {formatCnpj(inv.issuerCnpj)}
                          </div>
                        </div>
                      ) : (
                        <div>
                          ...
                          >
                            Dest: {formatCnpj(inv.recipientCnpj)}
                          </div>
                        </div>
                      )}
                    </td>
        ...
        <div className="modal-overlay">
          ...
          >
            <div className="modal-header">
              ...
              >
                DANFE Simplificada (Documento Auxiliar da Nota Fiscal
                Eletrônica)
              </h2>
              <button
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  onSyncInvoice(selectedInvoice.chave);
            ...
            <div className="danfe-container">
              ...
              <div className="danfe-box">
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  ...
                  >
                    ...
                    <div className="danfe-value">
                      {formatCurrency(selectedInvoice.value)}
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <div className="danfe-value">
                      {formatCurrency(selectedInvoice.value * 0.18)}
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <div className="danfe-value">
                      {formatCurrency(selectedInvoice.value * 0.0165)}
                    </div>
                  </div>
                  <div
                    style={{
                  ...
                  >
                    ...
                    <div className="danfe-value">
                      {formatCurrency(selectedInvoice.value * 0.076)}
                    </div>
                  </div>
                  <div style={{ flex: "1", padding: "0.25rem" }}>
                    <span className="danfe-label">Valor Total da Nota</span>
                    <div className="danfe-value" style={{ fontWeight: "bold" }}>
                      {formatCurrency(selectedInvoice.value)}
                    </div>
                  </div>
                </div>
                ...
                <tbody>
                  {getInvoiceItems(selectedInvoice.xmlContent).map((item) => (
                    <tr key={item.nItem}>
                      ...
                      <td>
                        {String(100 + parseInt(item.nItem)).padStart(5, "0")}
                      </td>
                      <td>{item.name}</td>
              ...
              >
                * Nota gerada de forma automática integrada ao sistema
                Alterdata. Protocolo de Autorização SEFAZ: 135200000000001
              </div>
            </div>
